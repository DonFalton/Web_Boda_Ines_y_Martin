  ...
  app.use(helmet({
    contentSecurityPolicy: {
      directives: {
        ...
        imgSrc: ["'self'", "data:", "blob:", "https://*.1drv.com", "https://*.sharepoint.com", "https://*.microsoftpersonalcontent.com", "https://*.svc.ms"],
        ...
        connectSrc: ["'self'", "https://*.up.1drv.com", "https://*.1drv.com", "https://*.sharepoint.com", "https://*.microsoftpersonalcontent.com"],
        frameAncestors: ["'none'"],
        objectSrc: ["'none'"],
        baseUri: ["'self'"],
        formAction: ["'self'"],
